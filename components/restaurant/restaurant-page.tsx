      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex justify-between items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            <button className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md text-gray-700 hover:text-orange-500 text-sm font-medium border border-gray-200">
              <MapPin className="w-4 h-4" />
              Get Direction
            </button>
            <button className="bg-white p-2 rounded-full shadow-md text-gray-700 hover:text-orange-500 border border-gray-200">
